...
\begin{figure}[H]
    \centering
 \includegraphics[width=0.8\linewidth]{maven.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width=0.8\linewidth]{pics1/Diagramma1.png} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{diagramma_er.png} 
